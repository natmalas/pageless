<template>
    <div class="theme-picker">
        <!-- Toggle button -->
        <v-btn icon variant="text" color="primary" @click="showThemes = !showThemes">
            <v-icon>mdi-palette</v-icon>
        </v-btn>
        <!-- Expanding theme bubbles -->
...
/**
 * Build presets dynamically from Vuetify themes
 */
